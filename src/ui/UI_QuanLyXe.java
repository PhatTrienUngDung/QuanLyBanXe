...
public class UI_QuanLyXe extends JFrame {
	...
	private JLabel lbXeConLai;
	private JLabel lbXeDaBan;
					...
					if (validDataXe() && KiemTraSoMay() == true) {
						try {
							...
							Xe xe = new Xe(ma, ten, new LoaiXe(loai), phienBan, mau, new NhaCungCap(ncc),
									new HangSanXuat(hsx), phankhoi, soKhung, soMay, giaNhap, ngay, trangThai, chuThich,
									img1);
							dao_qlXe.themXe(xe);
							JOptionPane.showMessageDialog(null, "Thêm thành công !!!");
							lbXeConLai.setText(dao_qlXe.XeConLai()+" xe");
							lbXeDaBan.setText(dao_qlXe.XeDaBan()+" xe");
							loadXe();
							Reset();
...
//					JOptionPane("Trùng")
		...
		btnThem.setBounds(23, 23, 125, 36);
		panel_7.add(btnThem);
		...
		btnXoa.setBounds(172, 23, 125, 36);
		panel_7.add(btnXoa);
		...
		btnCapNhat.setBounds(329, 23, 125, 36);
		...
		btnXoaTrang.setBounds(485, 23, 125, 36);
		panel_7.add(btnXoaTrang);

		JButton btnTT = new JButton("Chi tiết");
		btnTT.setFont(new Font("Tahoma", Font.BOLD, 13));
...
//Sắp xếp theo tên
	private void TenTangDan() throws SQLException {
		Dao_QuanLyXe dao_xe = new Dao_QuanLyXe();
		tableModel = dao_xe.SapXepTangDanTen();
		table.setModel(tableModel);
	}
	private void TenGiamDan() throws SQLException {
		Dao_QuanLyXe dao_xe = new Dao_QuanLyXe();
		tableModel = dao_xe.SapXepGiamDanTen();
		table.setModel(tableModel);
	}
//Sắp xếp theo giá
	private void GiaTangDan() throws SQLException {
		Dao_QuanLyXe dao_xe = new Dao_QuanLyXe();
		tableModel = dao_xe.SapXepTangDanGia();
		table.setModel(tableModel);
	}
	private void GiaGiamDan() throws SQLException {
		Dao_QuanLyXe dao_xe = new Dao_QuanLyXe();
		tableModel = dao_xe.SapXepGiamDanGia();
		table.setModel(tableModel);
	}
