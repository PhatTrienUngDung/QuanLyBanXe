...
public class CustomTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected void installDefaults() {
        ...
        selectColor = new Color(0, 225, 0);
        deSelectColor = new Color(0, 225, 0);
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
        ...
        int yp[] = null;
        Color colorTab= new Color(255, 255, 255);
        switch (tabPlacement) {
            case LEFT:
                xp = new int[]{x, x, x + w, x + w, x};
                yp = new int[]{y, y + h - 3, y + h - 3, y, y};
                gradientShadow = new GradientPaint(x, y, colorTab, x, y + h, colorTab);
                break;
            case RIGHT:
            ...
            default:
                ...
                gradientShadow = new GradientPaint(0, 0, colorTab, 0, y + h / 2, colorTab);
                break;
        }
        // ;
        ...
        if (isSelected) {
            ...
            if (tabPane.isEnabled() && tabPane.isEnabledAt(tabIndex)) {
                ...
                GradientPaint gradientShadowTmp = new GradientPaint(0, 0,colorTab, 0, y + h / 2, colorTab);
                g2D.setPaint(gradientShadowTmp);
            } else {
                GradientPaint gradientShadowTmp = new GradientPaint(0, 0, colorTab, 0, y + 15 + h / 2, colorTab);
                g2D.setPaint(gradientShadowTmp);
            }
        }
        g2D.fill(shape);
